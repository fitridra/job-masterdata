...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Add New Job Title</h5>
                ...
                <div class="card-body">
                    <form action="/store" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="JobCode" value="{{$newJobCode}}" id="exampleInputCode1" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputTitle1" class="form-label">Job Title</label>
                            <input type="text" class="form-control" name="JobTitleName" id="exampleInputTitle1" aria-describedby="titleHelp"
